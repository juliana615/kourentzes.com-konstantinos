...
class STSSM_Helper {
	...
	public static function icons_content() {
		return array( 'facebook', 'twitter', 'linkedin', 'pinterest', 'reddit', 'tumblr', 'blogger', 'evernote', 'getpocket', 'wordpress', 'line', 'whatsapp', 'envelope' );
	}

	public static function icons_sticky_side() {
		return array( 'facebook', 'twitter', 'linkedin', 'reddit', 'whatsapp', 'envelope' );
	}
